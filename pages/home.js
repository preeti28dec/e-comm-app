    ...
    return (
        <>
            ...
            <div className="flex justify-center text-lg my-4">
                ...
                <a href="#" className=" hover:text-blue-800">Hot Deal</a>
            </div>
                ...
                <div className='right_container'>
                    ...
                    <div>
                        ...
                        <Link href="/SingleItem">
                            <a className="mr-4 text-blue-400 header_text  ">
                                <div className='flex-wrap flex justify-center home_page_crad_ my-4 gap-6'>
                                    <div className="drop-shadow-md border rounded group relative ">
                                        ...
                                        <div className="p-5">
                                            <a href="#">
                                                <div className="item_section_barnd_name">Nike Air Max 270 React</div></a>
