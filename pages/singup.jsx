            ...
            <div className="max-w-md w-full space-y-8">
              ...
              <div className="flex flex-row justify-center items-center space-x-3">    
                <div className="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg   bg-blue-900 hover:shadow-lg cursor-pointer transition ease-in duration-300">
                  <Link href="https://www.facebook.com/preetithakurofficial">
                    <img
                      className="w-4 h-4"
              ...
              <div className="mt-8 space-y-6">
                ...
                <p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                  ...
                  <Link href="/login">
                    <button className="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">
                      go to Login page
                    </button>
                  </Link>
                </p>
