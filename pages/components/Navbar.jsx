    ...
    <div className="rounded-lg  md:px-6 md:py-4 ">
      <div className="bg-white sticky top-0 ">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
          ...
          <a>
            ...
            <a href="#" className="px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600">CONTACT</a>
          </div>
      ...
      <div className="flex items-center space-x-4">
        <div className="relative hidden md:block">
          ...
          <button type="button" className="mx-4 w-10 h-10 rounded-lg bg-gray-100 border border-gray-200 flex justify-center items-center"  onClick={Logout}><AiOutlineLogout/></button>
          </div>
