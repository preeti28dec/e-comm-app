    ...
    return (
        <div>
            ...
            <div className='font-bold text-center mt-6'>
                <span className='mx-6 text-blue-400'>All</span>
                <span className='mx-6 text-black hover:text-blue-500'>Bags</span>
                <span className='mx-6 text-black hover:text-blue-500'>Sneakers</span>
                <span className='mx-6 text-black hover:text-blue-500'>Belt</span>
                <span className='mx-6 text-black hover:text-blue-500'>Sunglasses</span>


            </div>
            <div className="bg-white">
                <div className=" mt-12 mx-12 card_main_container">
                    <div className=" mx-12 my-4 flex gap-10">
            ...
            <div className='text-center font-bold text-blue-500 my-6'>LEARN MORE</div>
        </div>
