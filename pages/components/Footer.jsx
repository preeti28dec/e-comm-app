    ...
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0 ">
            <a href="https://flowbite.com/" className="flex items-center">
                <img src="/docs/images/logo.svg" className="mr-3 h-8" alt="" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap ">E-Comm</span>
            </a>
            <div className='flex'>
            udjskf shdfihsf ioshfoh; iosfho; is;ah ooisah  srhfou is afhsijfh;s useo;aifkh ysoiyfo  ewoiiuj suf; usf; ui;fh hiasyhfb
            </div>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase ">Folloe Us</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://flowbite.com/" className="hover:underline">Contact Us</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" className="hover:underline">Infomation</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Our Offers</a>
                    </li>
                </ul>
            </div>
