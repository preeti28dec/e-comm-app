            ...
            <div className='bg-blue-300 px-8 py-12'>
                <div className='footer_first_row '>
                    <div className=''>
                        ...
                        <div className='footer_second_section_last_text'>Lorem Ipsum is simply dummy text of the<br /> printing and typesetting industry. Lorem <br />Ipsum has been the industry standard <br />dummy text ever.Since the 1500s, when <br />an unknown printer.</div>
                    </div>
                ...
                <div className='footer_hr_tag'>
                    ...
                    <div className="sm:flex items-center justify-between">
                        ...
                        <div className="flex-wrap flex space-x-6 sm:justify-center my-4">
