...
export default function ProductDetail() {
  ...
  useEffect(() => {
    const GetData = async () => {
      const res = await getProductApiId(id.id);
      setData(res);
    };
    GetData();
  }, [id]);
      ...
      <div className="py-6">
        ...
        <section className="text-gray-700 body-font overflow-hidden bg-white">
          <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 lg:gap-12 mx-auto flex flex-wrap">
              <img
                alt="ecommerce"
                className="lg:w-[40%] lg:h-[600px] w-full object-contain rounded border border-gray-200"
                src={data?.image}
              />
